...
$ToolsDir = Get-EnvironmentVariableOrDefault -Name 'TOOLS_DIR' -Default (Join-Path -Path $PSScriptRoot -ChildPath 'build/tools')
...
Invoke-Expression "& dotnet `"$CakeDLL`" $Script --bootstrap --Verbosity=Diagnostic"
